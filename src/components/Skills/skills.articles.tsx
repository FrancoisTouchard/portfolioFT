...
export const COMMUNICATION_ARTICLE = {
  definition: (
    <>
      <p>
      ...
      <p>
        Avec un designer ou un project manager, il faudra s’assurer de bien
        comprendre le besoin exprimé en posant les questions nécessaires et en
        argumentant objectivement ses éventuelles objections.
      </p>
      ...
      <p>
        ...
        vulgarisation un cran plus loin, et de rendre compréhensible par
        n’importe qui les enjeux techniques que l’on souhaite aborder.
      </p>
  ...
  proofs: (
    <>
      ...
      <p>
        En facilitant leur compréhension des enjeux techniques, ils avaient
        davantage tendance à valoriser mon travail car ils en comprenaient tous
  ...
  definition: (
    <>
      ...
      <p>
        ...
        développer, et plus elle sera simple à maintenir.
      </p>
  ...
  proofs: (
    <>
      <p>
        ...
        minimum de sensibilité requis, et d’un regard qui me permet de{' '}
        <b>
          repérer des défauts ou des optimisations possibles dès le premier coup
          d’oeil
        </b>{' '}
      ...
      <p>
        ...
        du module <i>Cours et Wiki</i> qui m’a été confié sur l’application
        mobile éditée par Édifice. Ce module permet à des enseignants de publier
        leurs cours, et aux élèves d’y accéder facilement.
      </p>

      <p>
        Lors de la phase de conception et de la présentation des maquettes par
        les designers, nous avions identifié plusieurs difficultés techniques
        quant aux choix représentés sur les maquettes. L’un d’entre eux
        concernait un composant de card où se trouvait la description du cours.
        Si cette card contenait beaucoup de texte, il fallait positionner un
        bouton <i>Voir plus</i> sur lequel cliquer pour la déplier. Sur la
        maquette, ce bouton était aligné avec la dernière ligne de texte
        visible, et impliquait de tronquer le texte pour laisser la place au
        bouton.
      </p>

      <p>
        Il se trouve que sur mobile, la méthode de détection de la valeur de
        hauteur d’une ligne de texte diffère selon les plateformes, et cela
        entraînait des complexités techniques pour une tâche a priori facile à
        réaliser. Nous avons résolu cette situation en changeant la position du
        bouton pour qu’il soit beaucoup plus simple à positionner, et donc
        rapide à développer.
      </p>

      <p>
        Je pense disposer d’une créativité assez prononcée, et je peux mesurer
        cela à la façon dont j’aborde un nouveau chantier, je me rends compte
        que mon oeil est beaucoup plus acéré qu’au début de mon parcours. J’ai
        tendance à <b>identifier rapidement les points problématiques</b>, et ma
        capacité à <b>simplifier des implémentations</b> s’est également
        beaucoup améliorée.
      </p>

      <p>
        Lorsque j’ai développé le carrousel multimédia, toujours chez Édifice,
        j’ai rencontré une situation qui me permet d’illustrer ma capacité à
        trouver des solutions simples permettant d’éviter un développement
        complexe.
      </p>

      <p>
        Lors de l’implémentation du composant permettant de visionner les pdf,
        la librairie que j’utilisais pour créer le carrousel présentait un bug :
        lorsqu’on avait qu’un seul pdf à visionner, il était affiché sur un
        composant doublon créé par la librairie pour permettre la logique de
        consultation circulaire des médias, au lieu d’être affiché sur le
        composant rendu à l’écran.
      </p>

      <p>
        Plutôt que de chercher un fix à ce bug complexe, j’ai tout simplement
        choisi de ne pas utiliser le carrousel pour ce cas spécifique où il n’y
        a qu’une seule ressource à visionner, je rendais directement mon
        composant permettant de visionner les pdf. N’ayant qu’une seule
  ...
  proofs: (
    <>
      ...
      <p>
        ...
        <i>Coding Academy</i> d’Epitech, qui imposait un rythme de travail
        soutenu pour parvenir à acquérir les bases de la programmation en
        partant quasiment de zéro. Aujourd’hui, après avoir complété cette
        formation par une alternance de 2 ans à l’ISCOD, je constate que{' '}
      ...
      <p>
        Je pense que mon premier projet personnel, <i>The Indigo Project</i>,
      ...
      <p>
        Pour citer un autre exemple en situation professionnelle, le carrousel
        multimédia que j’ai développé pour Édifice était un projet que
        l’entreprise avait &quot;dans les cartons&quot; depuis un moment, et
        dont les spécifications techniques et fonctionnelles étaient datées et
        assez vagues dans leur description.
      </p>

      <p>
        J’ai donc développé cette feature sans avoir d’idée précise de mon cap,
...
export const CRITICAL_THINKING_ARTICLE = {
  definition: (
    <>
      <p>
        L’esprit critique est la faculté à être{' '}
        <b>
          objectif et rationnel dans l’analyse et le jugement qu’on va porter
        </b>{' '}
      ...
      <p>
        ...
        . Il s’agit ensuite de savoir intégrer les retours qu’on nous fait et de
        savoir abandonner les convictions qu’on pouvaient avoir et qui se
        révèlent erronées.
      </p>
      ...
      <p>
        ...
        meilleur résultat. Toutefois, il faut savoir rester dans certaines
  ...
  proofs: (
    <>
      <p>
        Avoir fait une reconversion professionnelle à 30 ans vers un métier
      ...
      <p>
        ...
        en posant la question à une IA par exemple.
      </p>
      ...
      <p>
        ...
        livré une feature par exemple. Le réflexe que j’essaie d’avoir à ce
      ...
      <p>
        ...
        <b>et surtout l&apos;entretenir</b>, c’est une bonne habitude à prendre
        et à conserver.
      </p>
    </>
  ),
...
export const TYPESCRIPT_ARTICLE = {
  definition: (
    <>
      <p>
